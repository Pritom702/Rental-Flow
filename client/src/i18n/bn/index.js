...
export const patterns = [
  ...
  [/^Buy this for (৳[\d,.]+)\? The seller confirms in your chat, then you arrange the hand-over\. Pay only when you have the item\.$/,
    (m) => `${m[1]}-এ এটি কিনবেন? বিক্রেতা চ্যাটে নিশ্চিত করবেন, তারপর হস্তান্তরের ব্যবস্থা করবেন। জিনিস হাতে পেলে তবেই টাকা দিন।`],
  [/^Buy now at the asking price: (৳[\d,.]+)$/, (m) => `চাওয়া দামে এখনই কিনতে চান: ${m[1]}`],
  [/^(৳[\d,.]+), your asking price — accept it in the chat\.$/, (m) => `${m[1]}, আপনার চাওয়া দাম — চ্যাটে গ্রহণ করুন।`],
  [/^Pick up to (\d+) of your listings\. Next, choose a look — the Studio makes the video with a beat and writes the caption, free, right on your device\.$/,
    (m) => `আপনার লিস্টিং থেকে সর্বোচ্চ ${bnNum(m[1])}টি বাছুন। এরপর একটি লুক বাছুন — স্টুডিও বিটসহ ভিডিও বানাবে আর ক্যাপশন লিখে দেবে, বিনামূল্যে, আপনার ডিভাইসেই।`],
  [/^(\d+) of (\d+) picked$/, (m) => `${bnNum(m[2])}টির মধ্যে ${bnNum(m[1])}টি বাছা হয়েছে`],
  [/^Paid (৳[\d,.]+) through RentalFlow Pay$/, (m) => `RentalFlow Pay-এর মাধ্যমে ${m[1]} পরিশোধিত`],
  [/^Waiting for (.+) to pay through RentalFlow\.$/, (m) => `${m[1]}-এর RentalFlow-এর মাধ্যমে পরিশোধের অপেক্ষায়।`],
  [/^Pay (৳[\d,.]+)$/, (m) => `${m[1]} পরিশোধ করুন`],
  [/^(bKash|Nagad|Rocket) account number$/, (m) => `${{ bKash: 'বিকাশ', Nagad: 'নগদ', Rocket: 'রকেট' }[m[1]]} অ্যাকাউন্ট নম্বর`],
  [/^Paying with (.+)…$/, (m) => `${{ bKash: 'বিকাশ', Nagad: 'নগদ', Rocket: 'রকেট', Card: 'কার্ড' }[m[1]] || m[1]} দিয়ে পরিশোধ হচ্ছে…`],
  [/^Rent \((\d+) days?\)$/, (m) => `ভাড়া (${bnNum(m[1])} দিন)`],
  [/^You've posted (\d+) times in a row, so posting is paused for a (\d+)-minute break\. You can post again in (\d+) minutes?\.$/,
    (m) => `আপনি পরপর ${bnNum(m[1])}টি পোস্ট করেছেন, তাই ${bnNum(m[2])} মিনিটের বিরতি। ${bnNum(m[3])} মিনিট পর আবার পোস্ট করতে পারবেন।`],
  [/^(.+) paid (৳[\d,.]+)\. Arrange the hand-over in the chat\.$/, (m) => `${m[1]} ${m[2]} পরিশোধ করেছেন। চ্যাটে হস্তান্তরের ব্যবস্থা করুন।`],
  [/^(৳[\d,.]+) is on its way back to you — the booking did not go ahead\.$/, (m) => `${m[1]} আপনাকে ফেরত দেওয়া হচ্ছে — বুকিংটি হয়নি।`],
  [/^This booking is (\w+) and cannot be paid\.$/, (m) => `এই বুকিংটি ${m[1]}, তাই পরিশোধ করা যাবে না।`],
