...
export function Icon({ name, size = 20, className = '' }) {
  ...
  switch (name) {
    case 'alert':
      return <svg {...p}><path d="M12 3 2.5 20h19z" /><path d="M12 10v4.5" /><path d="M12 17.5v.01" /></svg>;
    case 'sound':
      return <svg {...p}><path d="M4 9v6h4l5 4V5L8 9z" /><path d="M16.5 8.5a5 5 0 0 1 0 7" /><path d="M19 6a8.5 8.5 0 0 1 0 12" /></svg>;
    case 'sound-off':
      return <svg {...p}><path d="M4 9v6h4l5 4V5L8 9z" /><path d="m17 9 5 6" /><path d="m22 9-5 6" /></svg>;
    case 'search':
    ...
    case 'moon':
      return <svg {...p}><path d="M20 14.5A8 8 0 0 1 9.5 4a8 8 0 1 0 10.5 10.5z" /></svg>;
    case 'sparkles':
    ...
    case 'chat':
      return <svg {...p}><path d="M21 12a8 8 0 0 1-11.6 7.1L4 20.5l1.4-4.9A8 8 0 1 1 21 12z" /><path d="M8.5 11h.01M12 11h.01M15.5 11h.01" /></svg>;
    case 'qr':
