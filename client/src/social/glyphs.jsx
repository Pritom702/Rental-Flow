...
const G = {
  ...
  edit: solid('M15.2 4.6l4.2 4.2L9 19.2l-5.2 1 1-5.2z') + line('M13 6.8l4.2 4.2'),
  ...
  lime: `<circle cx="12" cy="12" r="9.2" fill="${F}" stroke="${S}" stroke-width="1.6"/><circle cx="12" cy="12" r="6.6" fill="none" stroke="${S}" stroke-width="1.1" opacity=".55"/>`
    + line('M12 5.6v12.8M5.6 12h12.8M7.5 7.5l9 9M16.5 7.5l-9 9', 1.1) + dot(12, 12, 1.3),
  megaphone: solid('M3.6 10v4.2h3l7.8 4.4V5.6L6.6 10z') + line('M17.4 9.2a4 4 0 0 1 0 5.8M19.8 7a7.2 7.2 0 0 1 0 10.2M6.6 14.2l1.2 5.2h2.6l-.8-4.2'),
  clapper: solid('M3.6 9.4h16.8v10.2H3.6z') + solid('M3.4 9.4 3 6.2l16.2-2.6.6 3.2z', D, 1.4) + line('M7.8 5.4l2 3.4M12.4 4.7l2 3.4M17 3.9l1.9 3.4', 1.3),
  rocket: solid('M14.4 3.6c3-1 5.4-.8 6 0 .8.6 1 3-0 6l-6.8 6.8-6-6z') + line('M7.6 10.4 4.2 11l-1.6 3 4.4.6M13.6 16.4l-.6 3.4-3 1.6-.6-4.4M5.6 18.4c-.8.8-1.2 2.4-1.2 2.4s1.6-.4 2.4-1.2') + dot(15.6, 8.4, 1.5, D),
};
