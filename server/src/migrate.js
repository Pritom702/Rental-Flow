...
const ADDITIVE = ['schema_profile.sql', 'schema_verification.sql', 'schema_images.sql', 'schema_messages.sql', 'schema_categories.sql', 'schema_protection.sql', 'schema_social.sql'];
